...
public class EventServiceHttp {
	...
	public static com.acme.event.monitor.model.Event addEvent(
			HttpPrincipal httpPrincipal, long groupId, String eventType,
			String ipAddress,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, eventType, ipAddress, serviceContext);
			...
			return (com.acme.event.monitor.model.Event)returnObj;
		}
