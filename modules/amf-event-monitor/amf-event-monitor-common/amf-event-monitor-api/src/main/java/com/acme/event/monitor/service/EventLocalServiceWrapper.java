...
public class EventLocalServiceWrapper
	...
	public com.acme.event.monitor.model.Event addEvent(
		com.acme.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public com.acme.event.monitor.model.Event createEvent(long eventId) {
	 ...
	 */
	@Override
	public com.acme.event.monitor.model.Event deleteEvent(
		com.acme.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public com.acme.event.monitor.model.Event deleteEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.acme.event.monitor.model.Event fetchEvent(long eventId) {
	 ...
	 */
	@Override
	public com.acme.event.monitor.model.Event getEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.acme.event.monitor.model.Event> getEvents(
		int start, int end) {
	 ...
	 */
	@Override
	public com.acme.event.monitor.model.Event updateEvent(
		com.acme.event.monitor.model.Event event) {
