...
package amf.event.monitor.service.persistence;
...
public class EventUtil {
	...
	public static Event findByUserName(String userName)
		throws amf.event.monitor.exception.NoSuchEventException {
