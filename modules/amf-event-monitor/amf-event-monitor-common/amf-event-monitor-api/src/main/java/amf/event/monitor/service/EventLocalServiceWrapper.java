...
package amf.event.monitor.service;
...
public class EventLocalServiceWrapper
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event addEvent(
		amf.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event createEvent(long eventId) {
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event deleteEvent(
		amf.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event deleteEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public amf.event.monitor.model.Event fetchEvent(long eventId) {
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event getEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<amf.event.monitor.model.Event> getEvents(
		int start, int end) {
	 ...
	 */
	@Override
	public amf.event.monitor.model.Event updateEvent(
		amf.event.monitor.model.Event event) {
